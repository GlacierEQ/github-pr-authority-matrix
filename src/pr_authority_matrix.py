"""PR Authority Matrix — SCAFFOLD STUB.

Company lens: GitHub (independent; no affiliation).
Bottleneck: Bot and human PR actions blur who may merge, label, or force-push under policy.
...
class PrAuthorityMatrix:
    ...
    - `evaluate(req)` returns a PrAuthorityMatrixReceipt
    ...
    def evaluate(self, req: PrAuthorityMatrixRequest) -> PrAuthorityMatrixReceipt:
        reasons: list[str] = []
